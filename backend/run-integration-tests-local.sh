...
if [ ! -f "prisma/schema.prisma" ]; then
  echo "Error: schema.prisma file not found in prisma directory."
  echo "Please ensure your Prisma schema is properly configured."
  exit 1
fi

# Display the Prisma schema
...
# Run only auth and candidate tests, excluding database tests
